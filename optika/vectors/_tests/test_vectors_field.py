...
vectors_field = [
    optika.vectors.FieldVectorArray(
...
class AbstractTestAbstractFieldVectorArray(
    test_vectors_cartesian.AbstractTestAbstractCartesianVectorArray
):
    def test_field(self, array: optika.vectors.AbstractFieldVectorArray):
        assert isinstance(array.field, na.AbstractCartesian2dVectorArray)
    ...
    def test__getitem__(
        self,
        array: optika.vectors.AbstractFieldVectorArray,
